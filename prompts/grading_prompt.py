...
- References listed in the bibliography that are never cited in the text, or in-text citations with no bibliography entry
- Duplicate or inconsistently formatted references
- Any passages that appear verbatim from external sources without quotation marks or attribution
Report specific page/section locations for any issues found. If none found, state 'None detected'.
